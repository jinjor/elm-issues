...
if (typeof _user$project$ResetInput$main !== 'undefined') {
    _user$project$ResetInput$main(Elm['ResetInput'], 'ResetInput', {"types":{"unions":{"ResetInput.Msg":{"args":[],"tags":{"SetValue":["String","String"]}}},"aliases":{},"message":"ResetInput.Msg"},"versions":{"elm":"0.18.0"}});
}
