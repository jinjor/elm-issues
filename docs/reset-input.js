		...
		return A2(
			...
			'',
			{
				...
				_0: _user$project$ResetInput$setValue(
					{ctor: '_Tuple2', _0: 'input', _1: ''}),
				_1: {ctor: '[]'}
			});
	});
var _user$project$ResetInput$Reset = {ctor: 'Reset'};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$defaultValue('fooooo'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$ResetInput$Reset),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
if (typeof _user$project$ResetInput$main !== 'undefined') {
    _user$project$ResetInput$main(Elm['ResetInput'], 'ResetInput', undefined);
}
